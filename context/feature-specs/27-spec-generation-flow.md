...
1. Spec generation task
   ...
   Follow the existing Trigger.dev task patterns in the codebase for retries,
...
- Check `context/project-overview.md` and `context/architecture-context.md` for
  system alignment before implementing
