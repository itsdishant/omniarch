...
Resolved. The listed workspace, canvas, Blob, handle, drag/drop, avatar, and
navbar issues were fixed. Production build verification remains blocked in the
offline environment by `next/font` fetching `fonts.googleapis.com`.
